...
<li class="active"><?php if(isset($_GET['jxnu'])){ echo strtoupper($page=$_GET['jxnu']); } ?></li>
</ol>
</div>
<!--//sub-heard-part-->
<div class="graph-visual tables-main">
<h2 class="inner-tittle"><?php echo strtoupper($_GET['jxnu']); ?></h2>

<form method="post">
<select name="class_students_data" id="selector1" class="form-control1">
<option>Select Class</option>
<?php 
$opt = $jxnu->grade($grade);
...
$student_dis_admin=	$jxnu->student_info_display_admin($class_students_data);
$s_sn = 1;
