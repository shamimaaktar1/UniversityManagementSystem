...
<div class="forms-main">
	...
	$web_info_check = $jxnu->general_setting_check();
 ...
 if(isset($_POST['add_general_setting']))
 {
	 ...
	 $web_about = $_POST['web_about'];
	 	...
	 	$web_info_success = $jxnu->general_setting($web_name,$web_address,$web_phone1,$web_phone2,$web_email1,$web_email2,$web_start,$web_about);
