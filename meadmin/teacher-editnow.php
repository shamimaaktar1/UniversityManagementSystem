<?php 
 ...
 $edit_teacher_info = $jxnu->edit_teacherid($teacher_id);
...
if(isset($_POST['up_teacher']))
{
	...
	$update_done = $jxnu->update_teacher_info($up_fullname,$up_address,$up_email,$up_father,$up_mother,$up_dob,$up_qualification,$up_contact,$up_staff,$up_gender,$teacher_id);
	if($update_done==true)
	{
		echo "<script>window.location='home.php?jxnu=teacher-information';</script>";
	}
	else
	{
