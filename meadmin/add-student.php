<?php 
 ...
 if(isset($_POST['std_add_now']))
 {
	 ...
	 else
	 {
		 ...
		 $add_student_done = $jxnu->add_student($std_fullname,$std_username,$std_password,$std_grade,$std_roll,$std_dob,$std_address,$std_district,$std_gender,$std_father,$std_mother,$std_parent_contact);
...
<div class="forms-main">
	...
	<div class="graph-form">
		<div class="validation-form">
			<!---->
			<h2 align="center"><?php echo strtoupper($_GET['jxnu']); ?></h2>
			<form method="post">
